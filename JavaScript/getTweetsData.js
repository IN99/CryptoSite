...
var addTwitterData_1 = require("./addTwitterData");
...
function searchTweets(keyword) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, result, promiseArray_1, databaseResult, error_1;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    result.statuses.forEach(function (tweet) {
                        ...
                        promiseArray_1.push(addTwitterData_1.storeTwitterData(Number(tweet.id), keyword, tweet.text, Number(new Date(tweet.created_at).getTime() / 1000)));
                    });
...
//# sourceMappingURL=getTweetsData.js.map